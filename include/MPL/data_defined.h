...
////-------------------------asou funcs
//void append_asou(asou s);
//void append_all_asou(String s[][2],uint32 len,uint8 type);
////-------------------------coli funcs
//void append_coli(coli s);
////-------------------------vata funcs
//void append_vata(vata s);
////-------------------------vias funcs
//void append_vias(vias s);
//void append_to_vias(String inst,String op1,String op2,uint16 des,uint8 seg);
